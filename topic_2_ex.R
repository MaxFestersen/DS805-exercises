...
# >> Sample mean (of excess)
mu[1,] - mu[2,]

# >> Sample variance (of excess)
...
t(excess) %*% c(1, -1, 0, 0) # variance

sum(excess) # Excess of patrolium consumtion over natural gas sample covariance (sample covariance)
